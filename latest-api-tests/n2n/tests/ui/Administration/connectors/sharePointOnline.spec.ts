...
test.describe('Administration, connectors', async () => {
  ...
  test('Connectors: SharePoint Online @smoke @ui', async ({ page, request }) => {
    ...
    await adminPage.sharepointOnlineFillRequiredFields(connectorName);
...
test.describe('Administration, connectors', async () => {
  ...
  test.beforeEach(async ({ page, request }) => {
    adminPage = new AdminPage(page);
    await createAndPostConnector(request, 'sharePointOnLine', connectorName);
  });

  test('SharePoint online: delete connection @ui', async ({ page }) => {
    await adminPage.navigateTo('/administration/connections/sharepoint-online');
  ...
  test('SharePoint online: edit connection @ui', async ({ request }) => {
    ...
    await deleteConnector(request, 'sharePointOnLine', editedConnectorName);
  });
});
