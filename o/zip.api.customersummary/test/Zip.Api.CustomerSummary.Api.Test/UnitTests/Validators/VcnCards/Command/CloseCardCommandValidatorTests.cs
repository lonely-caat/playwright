...
{
    public class CloseCardCommandValidatorTests : CommonTestsFixture
    {
        private readonly CloseCardCommandValidator _validator;

        public CloseCardCommandValidatorTests()
        {
            _validator = new CloseCardCommandValidator();
        }

        [Fact]
        public void Given_Valid_CardId_Should_Not_Have_Error()
        {
            var result = _validator.Validate(new CloseCardCommand
            {
