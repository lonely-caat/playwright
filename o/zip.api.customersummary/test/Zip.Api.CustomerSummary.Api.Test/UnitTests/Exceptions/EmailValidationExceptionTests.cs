...
namespace Zip.Api.CustomerSummary.Api.Test.UnitTests.Exceptions
{
    public class EmailValidationExceptionTests
    {
        ...
        public EmailValidationExceptionTests()
        {
        ...
        {
            var target = new EmailValidationException();
        ...
        public void Given_Message_When_Instantiation_Then_Exception__Should_Be_Correct()
        {
            ...
            var target = new EmailValidationException(expectedMessage);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new EmailValidationException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new EmailValidationException("message", _innerException);

            // Action
            EmailValidationException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (EmailValidationException)formatter.Deserialize(deserializeMemoryStream);
            }
        ...
        {
            var target = new EmailValidationException("message");
