...
namespace Zip.Api.CustomerSummary.Api.Test.UnitTests.Exceptions
{
    public class ConsumerNotFoundExceptionTests
    {
        ...
        public ConsumerNotFoundExceptionTests()
        {
        ...
        {
            var target = new ConsumerNotFoundException();
        ...
        public void Given_Message_When_Instantiation_Then_Exception__Should_Be_Correct()
        {
            ...
            var target = new ConsumerNotFoundException(expectedMessage);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new ConsumerNotFoundException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new ConsumerNotFoundException("message", _innerException)
            {
                ConsumerId = _expectedConsumerId
            };

            // Action
            ConsumerNotFoundException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (ConsumerNotFoundException)formatter.Deserialize(deserializeMemoryStream);
            }
        ...
        {
            var target = new ConsumerNotFoundException("message");
