...
{
    public class CreditProfileNotFoundExceptionTests
    {
        ...
        public CreditProfileNotFoundExceptionTests()
        {
        ...
        {
            var target = new CreditProfileNotFoundException();
        ...
        public void Given_Message_When_Instantiation_Then_Exception__Should_Be_Correct()
        {
            ...
            var target = new CreditProfileNotFoundException(expectedMessage);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new CreditProfileNotFoundException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new CreditProfileNotFoundException("message", _innerException)
            {
                ConsumerId = _expectedConsumerId
            };

            // Action
            CreditProfileNotFoundException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (CreditProfileNotFoundException)formatter.Deserialize(deserializeMemoryStream);
            }
        ...
        {
            var target = new CreditProfileNotFoundException("message");
