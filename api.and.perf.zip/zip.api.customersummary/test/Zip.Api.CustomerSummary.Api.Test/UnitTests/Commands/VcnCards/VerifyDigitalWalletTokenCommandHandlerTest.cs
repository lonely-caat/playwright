...
{
    public class VerifyDigitalWalletTokenCommandHandlerTest : CommonTestsFixture
    {
        private readonly Mock<IVcnCardService> _vcnCardService;

        private readonly VerifyDigitalWalletTokenCommandHandler _target;

        public VerifyDigitalWalletTokenCommandHandlerTest()
        {
            _vcnCardService = new Mock<IVcnCardService>();
            _target = new VerifyDigitalWalletTokenCommandHandler(_vcnCardService.Object, Mapper);
        }
        ...
        public async Task Handle_Should_Invoke_VcnCardService_Correctly()
        {
            ...
            var expectedTokenTransitionRequest = Fixture.Build<TokenTransitionRequest>()
                                                        ...
                                                        .With(x => x.ReasonCode, Vcn.DigitalWalletTokenTransitionReasonCode_18)
                                                        .Create();
