...
{
    public class InternalConsumerControllerTests : CommonTestsFixture
    {
        private readonly InternalConsumerController _target;

        public InternalConsumerControllerTests()
        {
            _target = new InternalConsumerController(MockMediator.Object);
        }
