...
{
    public class MobilePhoneNotFoundExceptionTests
    {
        private readonly IFixture _fixture;

        private readonly Exception _innerException;

        public MobilePhoneNotFoundExceptionTests()
        {
        ...
        {
            var target = new MobilePhoneNotFoundException();
        ...
        public void Given_Message_When_Instantiation_Then_Exception__Should_Be_Correct()
        {
            ...
            var target = new MobilePhoneNotFoundException(expectedMessage);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new MobilePhoneNotFoundException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new MobilePhoneNotFoundException("message", _innerException);

            // Action
            MobilePhoneNotFoundException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (MobilePhoneNotFoundException)formatter.Deserialize(deserializeMemoryStream);
            }
        ...
        {
            var target = new MobilePhoneNotFoundException("message");
