...
{
    public class MobileValidationExceptionTests
    {
        private readonly IFixture _fixture;

        private readonly Exception _innerException;

        public MobileValidationExceptionTests()
        {
        ...
        {
            var target = new MobileValidationException();
        ...
        public void Given_Message_When_Instantiation_Then_Exception__Should_Be_Correct()
        {
            ...
            var target = new MobileValidationException(expectedMessage);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new MobileValidationException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new MobileValidationException("message", _innerException);

            // Action
            MobileValidationException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (MobileValidationException)formatter.Deserialize(deserializeMemoryStream);
            }
        ...
        {
            var target = new MobileValidationException("message");
