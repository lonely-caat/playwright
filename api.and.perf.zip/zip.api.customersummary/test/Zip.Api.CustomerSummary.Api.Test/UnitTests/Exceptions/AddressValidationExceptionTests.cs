...
{
    public class AddressValidationExceptionTests
    {
        private readonly IFixture _fixture;

        private readonly Exception _innerException;
        
        public AddressValidationExceptionTests()
        {
        ...
        {
            var target = new AddressValidationException();
        ...
        public void Given_Message_When_Instantiation_Then_Exception__Should_Be_Correct()
        {
            ...
            var target = new AddressValidationException(expectedMessage);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new AddressValidationException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new AddressValidationException("message", _innerException);
            
            // Action
            AddressValidationException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (AddressValidationException)formatter.Deserialize(deserializeMemoryStream);
            }
        ...
        {
            var target = new AddressValidationException("message");
