...
{
    public class CreatePaymentFailedExceptionTests
    {
        private readonly IFixture _fixture;

        private readonly Exception _innerException;

        public CreatePaymentFailedExceptionTests()
        {
        ...
        {
            var target = new CreatePaymentFailedException();
        ...
        public void Given_Message_When_Instantiation_Then_Exception__Should_Be_Correct()
        {
            ...
            var target = new CreatePaymentFailedException(expectedMessage);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new CreatePaymentFailedException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new CreatePaymentFailedException("message", _innerException);

            // Action
            CreatePaymentFailedException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (CreatePaymentFailedException)formatter.Deserialize(deserializeMemoryStream);
            }
        ...
        {
            var target = new CreatePaymentFailedException("message");
