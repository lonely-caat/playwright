...
{
    public class NonOperationalAccountExceptionTests
    {
        ...
        public NonOperationalAccountExceptionTests()
        {
        ...
        {
            var target = new NonOperationalAccountException();
        ...
        {
            var target = new NonOperationalAccountException(_expectedAccountId);
        ...
        public void Given_Message_And_InnerException_When_Instantiation_Then_Exception_Should_Be_Correct()
        {
            ...
            var target = new NonOperationalAccountException(expectedMessage, _innerException);
        ...
        {
            // Arrange
            var expect = new NonOperationalAccountException("message", _innerException)
            {
                AccountId = _expectedAccountId
            };

            // Action
            NonOperationalAccountException actual;
            ...
            using (var deserializeMemoryStream = new MemoryStream(buffer))
            {
                ...
                actual = (NonOperationalAccountException)formatter.Deserialize(deserializeMemoryStream);
            }
